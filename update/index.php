...
$step  = isset($_GET['step']) ? $_GET['step'] : '0';
	...
	if(!extension_loaded('mysql')){$error = TRUE; $check3 = "<span class='label label-danger'><i class='fa fa-times' aria-hidden='true'></i></span>";}else{$check3 = "<span class='label label-success'><i class='fa fa-check' aria-hidden='true'></i></i></span>";}
	            ...
	            <div class="tab-pane fade in active" id="Checklist">
			          ...
			          <table class="table table-striped">
					      ...
					      <tbody>
								...
								<tr><td>Mysql PHP extension</td><td><?php echo $check3; ?></td></tr>
