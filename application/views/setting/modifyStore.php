<div class="container container-small">
   <div class="row" style="margin-top:100px;">
     ...
     <div class="form-group col-md-6">
      <label for="invoice_begin"><?=label("Inicio factura");?></label>
      <input type="text" name="invoice_begin" value="<?=$store->invoice_begin;?>" class="form-control" id="invoice_begin" placeholder="<?=label("Inicio factura");?>">
     </div>
